                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <form class="m-t-20" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <label>Email</label>
                                    <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required="true" autofocus="true">
                                    @if ($errors->has('email'))
                            ...
                            <div class="row justify-content-between m-t-30 mb-0">
                                <div class="col-md-6">
                                  <a href="/password/reset" class="text-muted"><i class="fa fa-lock"></i> Forgot your password?</a>
                                </div>
